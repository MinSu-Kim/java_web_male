...
update book set rental_possible=1 where  book_code='6900000401';
...
update member_rental_info set now_total=now_total-1, total=total+1 where 'K0001';
...
update member_rental_info set now_total=now_total-1, total=total+1 where 'L0001';
...
update member_rental_info set now_total=now_total-1, total=total+1 where 'H0001';
...
update member_rental_info set now_total=now_total-1, total=total+1 where 'L0002';
...
/*대여 kny*/
insert into book_rental_info values(4,'2018-12-01',null,'2018-12-08' ,'K0002','3890000501');
select * from book_rental_info;

update book set rental_possible=0 where book_code='3890000501';

update member_rental_info set now_total=now_total-1, total=total+1 where 'K0002';
...
/*대여 psw*/
insert into book_rental_info values(4,'2018-12-10',null,'2018-12-18' ,'P0001','3890000502');
select * from book_rental_info;

update book set rental_possible=0 where book_code='3890000502';

update member_rental_info set now_total=now_total-1, total=total+1 where 'P0001';
...
/*대여 wsm*/
insert into book_rental_info values(4,'2018-12-23',null,'2018-12-30' ,'W0001','3890000503');
select * from book_rental_info;

update book set rental_possible=0 where book_code='3890000503';

update member_rental_info set now_total=now_total-1, total=total+1 where 'W0001';
...
/*대여 IU*/
insert into book_rental_info values(4,'2018-12-22',null,'2018-12-29' ,'U0001','3890000504');
select * from book_rental_info;

update book set rental_possible=0 where book_code='3890000504';

update member_rental_info set now_total=now_total-1, total=total+1 where 'U0001';
...
/*대여 uhj*/
insert into book_rental_info values(4,'2018-12-10',null,'2018-12-24' ,'U0002','3890000505');
select * from book_rental_info;

update book set rental_possible=0 where book_code='3890000505';

update member_rental_info set now_total=now_total-1, total=total+1 where 'U0002';


/*반납 uhj*/
update book_rental_info set return_date='2018-12-21' where member_no='U0002';
update member_rental_info set now_total=now_total+1
