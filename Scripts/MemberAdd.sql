...
VALUES('K0001', PASSWORD('dnlqh1220!'), '김재영', 'KJY', '010-9986-5500', concat(left('950316-1111111',8),password(right('950316-1111111',6))), 'rlawpdud301@naver.com', '41863대구광역시 서구 통학로 17 1, 1층','나연.jpg', true, null);
...
INSERT INTO proj_library.`member`
(member_no, password, kor_name, eng_name, phone, jumin, email, address, photo, admin, uniqueness)
VALUES('S0001', PASSWORD('dnlqh1220!'), '서동준', 'SDJ', '010-2230-6796', concat(left('910702-1111111',8),password(right('910702-1111111',6))), 'superdongte@naver.com', '41863대구광역시 서구 통학로 17 1, 5층','지민.jpg', false, null);
...
INSERT INTO proj_library.`member`
(member_no, password, kor_name, eng_name, phone, jumin, email, address, photo, admin, uniqueness)
VALUES('H0001', PASSWORD('dnlqh1220!'), '황경수', 'HKS', '010-2204-4493', concat(left('000316-1111111',8),password(right('000316-1111111',6))), 'krilln@naver.com', '41863대구광역시 서구 통학로 17 1, 1층','설현.jpg', false, null);
...
INSERT INTO proj_library.`member`
(member_no, password, kor_name, eng_name, phone, jumin, email, address, photo, admin, uniqueness)
VALUES('L0001', PASSWORD('dnlqh1220!'), '이천희', 'LCH', '010-5505-0468', concat(left('930121-1111111',8),password(right('930121-1111111',6))), 'rephanoise@naver.com', '41863대구광역시 서구 통학로 17 1, 1층','김유정.jpg', false, null);
...
INSERT INTO proj_library.`member`
(member_no, password, kor_name, eng_name, phone, jumin, email, address, photo, admin, uniqueness)
VALUES('U0001', PASSWORD('dnlqh1220!'), '유해진', 'UHJ', '010-0000-0000', concat(left('670121-1111111',8),password(right('670121-1111111',6))), 'aaaaaa@naver.com', '41863대구광역시 서구 통학로 17 1, 1층','장동건.jpg', false, null);
...
INSERT INTO proj_library.`member`
(member_no, password, kor_name, eng_name, phone, jumin, email, address, photo, admin, uniqueness)
VALUES('P0001', PASSWORD('dnlqh1220!'), '박수완', 'PSW', '010-5155-2701', concat(left('940101-2111111',8),password(right('940101-2111111',6))), 'psw2701@naver.com', '41863대구광역시 서구 통학로 17 1, 1층','원빈.jpg', false, null);
