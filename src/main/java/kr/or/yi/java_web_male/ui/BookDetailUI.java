...
public class BookDetailUI extends JFrame {
	...
	public BookDetailUI() {
																																																														...
																																																														panel_3.setLayout(new BorderLayout(0, 0));
																																																																...
																																																																btnbookRentalInfo.addActionListener(new ActionListener() {
																																																																	public void actionPerformed(ActionEvent e) {
																																																																		...
																																																																		JOptionPane.showMessageDialog(null, book.getBookCode());
																																																																		lists = service.selectBookRentalInfoByBookCode(book);
																																																																		/*forTable = new BookDetailTablePanel();*/
																																																																		forTable.setLists(lists);
		...
		contentPane.add(forTable);
		forTable.setLayout(new CardLayout(0, 0));
